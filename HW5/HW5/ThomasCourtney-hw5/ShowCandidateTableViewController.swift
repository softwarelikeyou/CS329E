...
class ShowCandidateTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        print("Candidates count is " + String(candidates.count))
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let selected: NSManagedObject = candidate!
        let d: CandidateInfoViewController = segue.destination as! CandidateInfoViewController
